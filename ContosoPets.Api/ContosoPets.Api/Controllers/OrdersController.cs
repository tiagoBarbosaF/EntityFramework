...
public class OrdersController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<List<CustomerOrder>>> Get() => await _orderService.GetAll();

    [HttpGet("{id}")]
    public async Task<ActionResult<CustomerOrder>> GetById(int id) => await _orderService.GetById(id);
